...
sub = plus_minus.filter(plus_minus["MinutesChange"] > 0)
columns_to_keep = ["TimeRemainingMinutes", "Minutes", "MinutesChange", "PlusMinusChange", "jw_raw_games.timestamp"]
...
sum_plus_minus_change = sub.agg(sum("PlusMinusChange")).collect()[0][0]
